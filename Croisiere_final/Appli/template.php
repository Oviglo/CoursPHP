                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="usermenu">
                                    <?php if (isset($_SESSION['user_admin']) && $_SESSION['user_admin'] == 1) {
                                        echo '<a href="index.php?p=admin_accueil" class="dropdown-item"><i class="fas fa-cogs"></i> Administration</a>';
                                    }?>
        ...
        <div class="container">
            ...
            if (count($flashMessages) > 0) {
                foreach ($flashMessages as $msg) {
                    echo '<div class="alert alert-'.$msg['type'].' alert-dismissible fade show">'.$msg['message'].'<button type="button" class="close" data-dismiss="alert" aria-label="Close">
